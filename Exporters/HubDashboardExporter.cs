...
<div class="grid-kpis hub-kpis">
    ...
    <div class="kpi {(metrics.CouplingSuspects > 0 ? "warning" : "good")}" augmented-ui="tr-clip bl-clip border">
        <div class="label">Implicit Coupling</div>
        <div class="value">{metrics.CouplingSuspects}</div>
        <div class="hint">Detected structural concentration toward specific modules</div>
    </div>
