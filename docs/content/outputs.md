...
Veja o RefactorScope em ação. A arquitetura de saída foi desenhada para fornecer feedback forense imediato no terminal (CLI) e projeções visuais profundas via Dashboards gerados.

## 01 // A Experiência CLI
O motor de análise rodando em tempo real. Rápido, verboso e com códigos de cores para alertas estruturais baseados na sua matriz de heurística.

<div id="cli-terminal-anchor"></div>

## 02 // Modos Seletores (Scan Modes)
O comportamento do CLI adapta-se ao escopo exigido pelo analista.

<div class="cyber-grid-2x2">
    <div class="selector-card">
        <div class="card-kicker">MODE: --fast</div>
        <h3>Heuristic Regex Scan</h3>
        <p>Ignora dependências transitivas profundas e foca na validação por Regex estrutural. Ideal para pipelines de CI/CD contínuos.</p>
    </div>
    <div class="selector-card">
        <div class="card-kicker">MODE: --strict</div>
        <h3>Deep AST Parsing</h3>
        <p>Monta a árvore sintática completa. Cruza dados complexos de herança, injeção de dependência e métricas ciclomáticas.</p>
    </div>
</div>

## 03 // Parser Arena Breakdown
A análise do RefactorScope consolida todo o tracking de inteligência em relatórios HTML puros, livres de dependências externas.

<div class="image-showcase panel" augmented-ui="tl-clip br-clip border">
    <img src="assets/img/arenabreakdown.jpeg" alt="Exemplo de Dashboard HTML" style="width: 100%; display: block;">
</div>

## 04 // Dashboards Estáticos Gerados
A análise do RefactorScope consolida todo o tracking de inteligência em relatórios HTML puros, livres de dependências externas.

<div class="image-showcase panel" augmented-ui="tl-clip br-clip border">
    <img src="assets/img/arenacharts.jpeg" alt="Exemplo de Dashboard HTML" style="width: 100%; display: block;">
</div>
